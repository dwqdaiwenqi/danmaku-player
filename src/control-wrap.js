...
define('control-wrap', class extends WeElement {
                            ...
                            <div class="iconfont_setting" >
                              ...
                              <div class="control_setting_pannel" style={{display: this.data.showSettingPannel?'block':'none'}}>
                                <div class="control_setting_pannel_wrap">
                                  ...
                                  <div ref={el => this.$control_setting_pannel_scale = el} class="control_setting_pannel_scale">
                                    <span  class="control_setting_pannel_demonstration">画面尺寸</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="control_bottom_comment_setting_pannel" style={{display: this.data.showSettingDanmakuPannel?'block':'none'}}>
                            ...
                            <div class="control_bottom_comment_setting_path_wrap comment_setting_item">
                              ...
                              <div style="width:70%;float:right;" ref={el=>{this.$path_container=el}} onClick={this.handlePickMode}>
                                <div class="setting_path_linear setting_path" data-path="linear">
  ...
  handlePickMode = (e) => {
    ...
    $paths.forEach($co => {
      $paths.forEach($co=>$co.classList.remove('setting_alpah--picked'))
    })
    e.target.classList.add('setting_alpah--picked')
  ...
  handlePickColor = (e) => {
    ...
    this.data.danmakuColor =  getComputedStyle(e.target, null)['background-color']
  ...
  handleSliderMouseMove = (e) => {
    ...
    //  x/24 = 2  1秒截一张图
    // x = 48  48 帧
    // 每隔一千帧(秒数=1000/fps24)即41s截一张图
    // 总时长3*60=180
    // title =  180/2 = 90张
    //ffmpeg -i Galileo.mp4 -frames 1 -vf "select=not(mod(n\,48)),scale=160:90,tile=90*1" src/assets/thumbnail-tile-90X1-scale-160X90.png
